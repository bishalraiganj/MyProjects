...
public class RsaCipher {
		...
		public BigInteger n = p.multiply(q) ; // modulus

		private BigInteger eulerPhi = (p.subtract(BigInteger.valueOf(1L))).multiply( (q.subtract(java.math.BigInteger.valueOf(1L)))); // This is the totient function

		public BigInteger publicKey  = BigInteger.valueOf(65537L); //public key
